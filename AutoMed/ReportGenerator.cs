        ...
        */
        private static Dictionary<string, Func<dynamic, string>> QuoteColumns =
            ...
            {   // Name Displayed To User, What It Returns
                ...
                { "Eligible Cost", q => q.EligibleCost.ToString() },
                { "Mandatory Cost", q => q.MandatoryCost.ToString() },
                { "Expenses", q=> q.Expenses.ToString()},
                { "Income", q=> q.Income.ToString()},
                { "Adjusted Income", q=> q.AdjustedIncome.ToString()},
                ...
                { "Customer Address", q => $"{q.Customer.AddressLine1} {q.Customer.AddressLine2}"},
